import{R as t,r as E,c as r}from"./index.1c33d5c1.js";import{ac as i,ay as m,a as d}from"./tree.ce5c4568.js";import{c as p,r as y}from"./config.a1c6c2af.js";import{I as f}from"./index.c84422bf.js";import{m as c}from"./index.b9dd85a1.js";const h=[{name:"senderName",label:"\u53D1\u9001\u4EBA\u59D3\u540D",rules:[{message:"\u8BF7\u8F93\u5165",required:!0}],children:t.createElement(f,{placeholder:"\u8BF7\u8F93\u5165"})}],F=()=>t.createElement(d,{fields:h}),k=[{children:"\u5237\u65B0",type:"primary",onClick:(l,n)=>{var e;(e=n.table.refresh())==null||e.then(()=>{c.success("\u65B0\u5EFA\u6210\u529F")})}},{children:"\u65B0\u589E",type:"primary",onClick:(l,n)=>{n.modal.open({title:"\u65B0\u5EFA",children:t.createElement(F,null),onOk(){n.modal.close(),n.table.refresh()}})}}],A=()=>{const l=e=>[{children:"\u7F16\u8F91",onClick:()=>{e.modal.open({title:"\u7F16\u8F91",initialValues:e.record,children:t.createElement(F,null),onOk(){e.modal.close(),e.table.refresh()}})}},{children:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",onClick:()=>new Promise(s=>{setTimeout(()=>{c.success("\u5220\u9664\u6210\u529F"),s("")},1e3)}).then(()=>{e.table.refresh()})}],n=[...p,{key:"operator",title:"\u64CD\u4F5C",render:e=>t.createElement(i,{actions:l(e)})}];return t.createElement(m,{fields:h.map(e=>({...e,rules:[]})),columns:n,actions:k,remoteDataSource:y})},R=`import React from 'react';
import {
  QueryTable,
  TextActions,
...
export default Demo;
`,Q=void 0,O=void 0,B={code:R,title:Q,desc:O},M=!0;var S=Object.freeze(Object.defineProperty({__proto__:null,demoMeta:B,isDemo:M,default:A},Symbol.toStringTag,{value:"Module"}));const C=[{name:"senderName",label:"\u53D1\u9001\u4EBA\u59D3\u540D",rules:[{message:"\u8BF7\u8F93\u5165",required:!0}],children:t.createElement(f,{placeholder:"\u8BF7\u8F93\u5165"})}],b=()=>t.createElement(d,{fields:C}),P=()=>{const l=E.exports.useRef(),n=[{children:"\u5BFC\u51FA",type:"primary",disabled:()=>{var u;const{table:o}=l.current||{};return o?!((u=o.getSelectedRows())!=null&&u.length):!0},onClick:(o,u)=>{console.log("\u9009\u4E2D\u884C",u.table.getSelectedRowKeys())}},{children:"\u5237\u65B0",type:"primary",onClick:(o,u)=>{var T;(T=u.table.refresh())==null||T.then(()=>{c.success("\u65B0\u5EFA\u6210\u529F")})}},{children:"\u65B0\u589E",type:"primary",onClick:(o,u)=>{u.modal.open({title:"\u65B0\u5EFA",children:t.createElement(b,null),onOk(){u.modal.close(),u.table.refresh()}})}}],e=o=>[{children:"\u7F16\u8F91",onClick:()=>{o.modal.open({title:"\u7F16\u8F91",initialValues:o.record,children:t.createElement(b,null),onOk(){o.modal.close(),o.table.refresh()}})}},{children:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",onClick:()=>new Promise(u=>{setTimeout(()=>{c.success("\u5220\u9664\u6210\u529F"),u("")},1e3)}).then(()=>{o.table.refresh()})}],s=[...p,{key:"operator",title:"\u64CD\u4F5C",render:o=>t.createElement(i,{actions:e(o)})}];return t.createElement(m,{ref:l,fields:C.map(o=>({...o,rules:[]})),columns:s,rowSelection:!0,actions:n,remoteDataSource:y})},w=`import React, { useRef } from 'react';
import {
  QueryTable,
  TextActions,
  QueryTableActionType,
