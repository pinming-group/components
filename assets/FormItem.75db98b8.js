...
export default Demo;
`,R=void 0,P=void 0,M={code:j,title:R,desc:P},x=!0;var z=Object.freeze(Object.defineProperty({__proto__:null,demoMeta:M,isDemo:x,default:$},Symbol.toStringTag,{value:"Module"}));const F={labelCol:{style:{width:140}},span:12},b=[{value:"zhejiang",label:"\u6D59\u6C5F",children:[{label:"\u676D\u5DDE",value:"hangzhou"}]},{value:"beijing",label:"\u5317\u4EAC",children:[{label:"\u4E09\u91CC\u5C6F",value:"sanlitun"}]},{value:"shanghai",label:"\u4E0A\u6D77",children:[{label:"\u4E0A\u6D77",value:"shanghai"}]}],q=()=>{const[t]=a.useForm(),[r,u]=N.exports.useState([]);return n.createElement(d,{title:"\u57FA\u7840\u5173\u8054"},n.createElement(a,{form:t},n.createElement(i,{gutter:24},n.createElement(l,{name:"province",label:"\u7701",...F,remoteDataSource:()=>Promise.resolve(b),children:n.createElement(o,{placeholder:"\u8BF7\u9009\u62E9\u7701\u4EFD",onChange:v=>{const C=b.find(D=>D.value===v);u((C==null?void 0:C.children)||[]),t.setFieldsValue({city:void 0})}})}),n.createElement(l,{name:"city",label:"\u5E02",...F,dataSource:r,children:n.createElement(o,{placeholder:"\u8BF7\u9009\u62E9\u5730\u56FE"})}))))},O=`import React, { useState } from 'react';
import { Form, FormItem, Select } from '@dreame/ui';
