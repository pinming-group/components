import{r as c,R as t,c as e}from"./index.b451a6b4.js";import{aw as G,f as k,au as H,ax as q,ay as J,az as Q,B as U,G as W,I as Y,a7 as Z,d as V,E as ee}from"./tree.feb2c467.js";import{I as te}from"./index.29e311ad.js";import{m as C}from"./index.18e9e184.js";import{P as ne}from"./PlusOutlined.bbce47f4.js";import{D as re}from"./DeleteOutlined.d44088ab.js";const{Search:oe}=te,D=(r,o)=>{let l;for(let a=0;a<o.length;a++){const n=o[a];n.children&&(n.children.some(p=>p.key===r)?l=n.key:D(r,n.children)&&(l=D(r,n.children)))}return l},N=[],R=r=>{for(let o=0;o<r.length;o++){const l=r[o],{key:a,title:n}=l;N.push({key:a,title:n}),l.children&&R(l.children)}},O=r=>{const{loading:o=!1,searchProps:l,showSearch:a=!0,treeData:n,operatorRender:p,showOperatorOnHover:F=!0,extraRender:x,defaultExpandAll:f,treeNodeTitleStyle:v,descriptionInLine:T,onTreeNodeHover:h,...w}=r,[M,b]=c.exports.useState(void 0),[_,P]=c.exports.useState(!1),[K,z]=c.exports.useState("1"),E=c.exports.useRef(""),i=G("tree");c.exports.useEffect(()=>(R(n),()=>{N.length=0}),[n]);const I=c.exports.useCallback(u=>{const{value:d}=u.target;E.current=d;const m=N.map(s=>s.title.indexOf(d)>-1?D(s.key,n):null).filter((s,y,g)=>s&&g.indexOf(s)===y);b(m),P(!0),f&&z(d!=null&&d.length?"2":"1")},[n]),$=c.exports.useCallback(u=>{P(!1),b(u)},[]),j=c.exports.useCallback((u,d)=>{const{title:m,description:s}=u,y=m.indexOf(d),g=m.substring(0,y),X=m.slice(y+d.length),A=y>-1?t.createElement("span",null,g,t.createElement("span",{className:i+"-treenode-highlight-text"},d),X):t.createElement("span",null,m);return p?t.createElement("div",{className:k(i+"-treenode"),onMouseEnter:()=>{h==null||h(u)}},t.createElement("div",{className:k(i+"-treenode-title",{[i+"-treenode-title-description-inline"]:T}),style:v},t.createElement("div",null,A),s?t.createElement(H,{type:"secondary"},s):null),t.createElement("div",{className:k({[i+"-treenode-operator"]:!0,[i+"-treenode-operator-show"]:!F,[i+"-treenode-operator-showonhover"]:F}),onClick:L=>{L.stopPropagation()}},p(u))):A},[p]);return t.createElement(q,{spinning:o},a&&t.createElement("div",{className:i+"-search"},t.createElement(oe,{style:{marginBottom:8},onChange:I,allowClear:!0,...l}),x&&t.createElement("div",{className:i+"-extra"},x())),n!=null&&n.length?t.createElement(J,{key:K,blockNode:!0,...w,treeData:n,onExpand:$,defaultExpandAll:f,...f&&!E.current?{}:{expandedKeys:M},autoExpandParent:_,titleRender:u=>j(u,E.current)}):t.createElement(Q,null))},le=[{id:"0",title:"0",key:"0",children:[{id:"0-0",title:"0-0",key:"0-0"},{id:"0-1",title:"0-1",key:"0-1"},{id:"0-3",title:"0-2",key:"0-2",children:[{id:"0-2-1",title:"0-2-0",key:"0-2-0"}]}]},{id:"1",title:"1",key:"1",children:[{id:"1-0",title:"1-0",key:"1-0"},{id:"1-1",title:"1-1",key:"1-1"},{id:"1-2",title:"1-2",key:"1-2",children:[{id:"1-2-1",title:"1-2-0",key:"1-2-0"}]}]}],ae=()=>t.createElement(O,{searchProps:{placeholder:"\u8BF7\u8F93\u5165\u641C\u7D22\u540D\u79F0"},onSelect:(r,o)=>{console.log(r,o)},defaultExpandAll:!0,treeData:le,operatorRender:()=>t.createElement("div",null,"\u64CD\u4F5C\u6309\u94AE")}),ie=`import React from 'react';
import { Tree } from 'luckybird';
...
import { Tree, ButtonAction, DropdownButton, IconAction } from 'luckybird';
import { message } from 'antd';
import { PlusOutlined, CopyOutlined, EditOutlined, DeleteOutlined, EllipsisOutlined } from '@ant-design/icons';
import type { DataNode, ButtonActionProps, TreeProps } from 'luckybird';
