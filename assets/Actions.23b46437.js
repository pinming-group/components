import{R as n,c as e}from"./index.1c33d5c1.js";import{S as s,B as d,a5 as C,a6 as N,a7 as a,a8 as i,a9 as o,aa as A,ab as f,ac as y}from"./tree.ce5c4568.js";import{m as l}from"./index.b9dd85a1.js";import{d as g}from"./zh_CN.266838fe.js";import{D as p}from"./DeleteOutlined.28fb361c.js";const k=()=>n.createElement(s,null,n.createElement(d,{children:"\u65B0\u589E",type:"primary",onClick:()=>{console.log("Action 1")}}),n.createElement(d,{disabled:!0,children:"\u65B0\u589E",tooltip:"\u8BBE\u7F6Edisabled\u88AB\u7981\u7528\u4E86~",onClick:()=>{console.log("Action 1")}}),n.createElement(d,{children:"\u7F16\u8F91",onClick:()=>(console.log("Action \u7F16\u8F91"),new Promise(t=>{setTimeout(()=>{l.success("\u7F16\u8F91\u6210\u529F"),t(!0)},2e3)}))}),n.createElement(d,{children:"\u5220\u9664",danger:!0,confirm:"\u786E\u8BA4\u5220\u9664?",onClick:t=>(console.log("Action \u5220\u9664",t),new Promise((u,r)=>{setTimeout(()=>{l.error("\u5220\u9664\u5931\u8D25"),r(!0)},2e3)}))})),B=`

import React from 'react';
import { message, Space } from 'antd';
import { ButtonAction } from '@dreame/ui';
...
`,b="ButtonAction",h="\u6309\u94AE",D={code:B,title:b,desc:h},P=!0;var w=Object.freeze(Object.defineProperty({__proto__:null,demoMeta:D,isDemo:P,default:k},Symbol.toStringTag,{value:"Module"}));const v=()=>{const t=[{children:"\u65B0\u589E",type:"primary",onClick:()=>{console.log("Action 1")}},{disabled:!0,children:"\u65B0\u589E",tooltip:"\u8BBE\u7F6Edisabled\u88AB\u7981\u7528\u4E86~",onClick:()=>{console.log("Action 1")}},{children:"\u7F16\u8F91",onClick:()=>(console.log("Action \u7F16\u8F91"),new Promise(u=>{setTimeout(()=>{l.success("\u7F16\u8F91\u6210\u529F"),u(!0)},2e3)}))},{children:"\u5220\u9664",danger:!0,confirm:"\u786E\u8BA4\u5220\u9664?",onClick:u=>(console.log("Action \u5220\u9664",u),new Promise((r,c)=>{setTimeout(()=>{l.error("\u5220\u9664\u5931\u8D25"),c(!0)},2e3)}))}];return n.createElement(C,{locale:g},n.createElement(N,{actions:t}))},O=`

import React from 'react';
import { ConfigProvider, message } from 'antd';
import { ButtonActions } from '@dreame/ui';
import type { ButtonActionsProps } from '@dreame/ui';
...
`,j="IconAction",M="\u6309\u94AE",z={code:$,title:j,desc:M},H=!0;var X=Object.freeze(Object.defineProperty({__proto__:null,demoMeta:z,isDemo:H,default:S},Symbol.toStringTag,{value:"Module"}));const q=()=>{const t=[{icon:o,tooltip:"\u7F16\u8F91",onClick:()=>{console.log("Action 1")}},{icon:f,tooltip:"\u590D\u5236~",onClick:()=>{console.log("Action 1")}},{icon:o,tooltip:"\u7F16\u8F91",onClick:()=>(console.log("Action \u7F16\u8F91"),new Promise(r=>{setTimeout(()=>{l.success("\u7F16\u8F91\u6210\u529F"),r(!0)},2e3)}))},{icon:p,tooltip:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",onClick:r=>(console.log("Action \u5220\u9664",r),new Promise(c=>{setTimeout(()=>{l.success("\u5220\u9664\u6210\u529F"),c(!0)},2e3)}))},{icon:p,confirm:"\u786E\u8BA4\u5220\u9664?",type:"error",onClick:r=>(console.log("Action \u5220\u9664",r),new Promise((c,E)=>{setTimeout(()=>{l.error("\u5220\u9664\u5931\u8D25"),E(!0)},2e3)}))}],u=[{icon:o,text:"\u7F16\u8F91",onClick:()=>{console.log("Action 1")}},{icon:f,text:"\u590D\u5236~",onClick:()=>{console.log("Action 1")}},{icon:o,text:"\u7F16\u8F91",onClick:()=>(console.log("Action \u7F16\u8F91"),new Promise(r=>{setTimeout(()=>{l.success("\u7F16\u8F91\u6210\u529F"),r(!0)},2e3)}))},{icon:p,text:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",onClick:r=>(console.log("Action \u5220\u9664",r),new Promise(c=>{setTimeout(()=>{l.success("\u5220\u9664\u6210\u529F"),c(!0)},2e3)}))},{icon:p,confirm:"\u786E\u8BA4\u5220\u9664?",type:"error",text:"\u5220\u9664",onClick:r=>(console.log("Action \u5220\u9664",r),new Promise((c,E)=>{setTimeout(()=>{l.error("\u5220\u9664\u5931\u8D25"),E(!0)},2e3)}))}];return n.createElement(C,{locale:g},n.createElement(a,null,n.createElement(A,{actions:t})),n.createElement(a,null,n.createElement(A,{actions:u})))},L=`

import React from 'react';
import { ConfigProvider, message, Row } from 'antd';
import { CopyOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';
import { IconActions } from '@dreame/ui';
import type { IconActionsProps } from '@dreame/ui';
import zhCH from 'antd/lib/locale/zh_CN';
...
export default IconActionDemo;
`,G="IconActions",J="\u6309\u94AE",K={code:L,title:G,desc:J},Q=!0;var U=Object.freeze(Object.defineProperty({__proto__:null,demoMeta:K,isDemo:Q,default:q},Symbol.toStringTag,{value:"Module"}));const V=()=>{const t=[{render:!1,children:"\u65B0\u589E",onClick:()=>{console.log("Action 1")}},{disabled:!0,children:"\u65B0\u589E",tooltip:"\u524D\u9762\u8FD8\u6709\u4E00\u4E2A\u6CA1\u6E32\u67D3\u7684\u6309\u94AE\u5440~",onClick:()=>{console.log("Action 1")}},{children:"\u7F16\u8F91",onClick:()=>(console.log("Action \u7F16\u8F91"),new Promise(u=>{setTimeout(()=>{l.success("\u7F16\u8F91\u6210\u529F"),u(!0)},2e3)}))},{children:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",onClick:u=>(console.log("Action \u5220\u9664",u),new Promise(r=>{setTimeout(()=>{l.success("\u5220\u9664\u6210\u529F"),r(!0)},2e3)}))},{children:"\u5220\u9664",confirm:"\u786E\u8BA4\u5220\u9664?",type:"danger",onClick:u=>(console.log("Action \u5220\u9664",u),new Promise((r,c)=>{setTimeout(()=>{l.error("\u5220\u9664\u5931\u8D25"),c(!0)},2e3)}))}];return n.createElement(C,{locale:g},n.createElement(y,{actions:t}))},W=`

import React from 'react';
import { ConfigProvider, message } from 'antd';
import { TextActions } from '@dreame/ui';
import type { TextActionsProps } from '@dreame/ui';
import zhCH from 'antd/lib/locale/zh_CN';
