import{r as m,R as r,c as n}from"./index.b451a6b4.js";import{r as d}from"./config.1b5e04c0.js";import{H as c,aD as i}from"./tree.feb2c467.js";import{I as l}from"./index.29e311ad.js";import{m as s}from"./index.18e9e184.js";import{I as p}from"./index.14158b9b.js";const f=[{dataIndex:"name",key:"name",title:"name",tooltip:"\u63D0\u793A",renderEditNode:()=>r.createElement(l,{size:"small"}),editFormItemProps:{rules:[{required:!0,message:"\u8BF7\u8F93\u5165name"}]}},{dataIndex:"age",key:"age",title:"age",renderEditNode:()=>r.createElement(p,{size:"small"})}],b=()=>{const t=e=>{console.log("value",e)},o=m.exports.useRef();return r.createElement("div",null,r.createElement(c,{onClick:()=>{var e;(e=o.current)==null||e.add({name:"abc",age:123})}},"\u5916\u90E8\u6DFB\u52A0"),r.createElement(i,{fields:[{name:"a",label:"a",children:r.createElement(l,null)}],onChange:t,columns:f,ref:o,remoteDataSource:d,onDelete:async e=>{await new Promise(a=>{setTimeout(a,2e3)}),s.success(`\u5220\u9664${e}`)},onSave:async e=>{await new Promise(a=>{setTimeout(a,2e3)}),console.log("save",e),s.success(`\u4FDD\u5B58${e.id}`)}}))},g=`import React, { useRef } from 'react';\r
import { Button, Input, InputNumber, message } from 'antd';\r
import { remoteDataSource } from '../../../Table/demos/config';\r
import { EditableQueryTable, type EditableQueryTableInstance } from 'luckybird';\r
\r
const columns = [\r
  {\r
    dataIndex: 'name',\r
